...
- 団体等からのご意見資料やパブリックコメント結果（「団体等からのご意見」「パブリックコメント結果」「意見募集結果」など）は、会議全体の要約において優先度が低いため、スコアを2段階下げてください
...
- **資料名に「団体等からのご意見」「パブリックコメント結果」「意見募集結果」などが含まれる資料は、スコアを2段階下げてください**
    """)
